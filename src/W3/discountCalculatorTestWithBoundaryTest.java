...
public class discountCalculatorTestWithBoundaryTest {
    @ParameterizedTest
    @CsvFileSource(resources = "testcase/discountCalculatorTestWithBoundaryTest_validdata.csv", numLinesToSkip = 1)
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "testcase/discountCalculatorTestWithBoundaryTest_invaliddata.csv", numLinesToSkip = 1)
